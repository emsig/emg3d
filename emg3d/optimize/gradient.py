...
def gradient(simulation):
    ...
    for src in simulation.survey.sources.keys():
        ...
        for freq in simulation.survey.frequencies:
            ...
            efield = -np.real(
                    simulation._bfields[src][freq] *
                    simulation._efields[src][freq] *
                    simulation._efields[src][freq].smu0)
